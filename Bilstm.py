...
train_df = pd.read_csv('C:/Users/msoha/OneDrive/Documents/DATASET/RUL/train_FD004.txt', sep=" ", header=None)
...
test_df = pd.read_csv('C:/Users/msoha/OneDrive/Documents/DATASET/RUL/test_FD004.txt', sep=" ", header=None)
test_df.drop(test_df.columns[[26, 27]], axis=1, inplace=True)
test_df.columns = ['id', 'cycle', 'setting1', 'setting2', 'setting3', 's1', 's2', 's3',
                     's4', 's5', 's6', 's7', 's8', 's9', 's10', 's11', 's12', 's13', 's14',
                     's15', 's16', 's17', 's18', 's19', 's20', 's21']

truth_df = pd.read_csv('C:/Users/msoha/OneDrive/Documents/DATASET/RUL/RUL_FD004.txt', sep=" ", header=None)
...
history = model.fit(seq_array, label_array, epochs=25, batch_size=200, validation_split=0.05, verbose=2,
...
test_input_data=seq_array_test_last.reshape(11400,25)
